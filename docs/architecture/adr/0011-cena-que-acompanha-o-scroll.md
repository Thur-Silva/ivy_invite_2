...
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Colocar o companheiro dentro do canvas WebGL            | Precisaria projetar coordenadas de scroll para espaço 3D e desapareceria nos níveis 1 a 2 da degradação, justamente onde a página fica mais sem vida.                                                                                      |
