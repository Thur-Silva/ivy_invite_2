...
| Conta do convidado     | `GuestAccount`          | Value Object   | Identidade verificada por Google ou Facebook. `provider + subject` e o par que identifica a pessoa; e-mail serve para sugerir o primeiro nome. E a identidade FORTE, e carrega a regra uma resposta por convidado. |
...
| Primeiro nome sugerido | `suggestedFirstName()`  | método         | Palpite tirado da parte local do e-mail (arthur.cruz vira Arthur), com o nome do provedor como reserva. Sempre editavel pelo convidado.                                                                            |
