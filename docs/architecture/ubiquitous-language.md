...
| Conta do convidado     | `GuestAccount`          | Value Object   | Identidade verificada pelo Google. `provider + subject` e o par que identifica a pessoa; e-mail serve para sugerir o primeiro nome. E a identidade FORTE, e carrega a regra uma resposta por convidado. |
